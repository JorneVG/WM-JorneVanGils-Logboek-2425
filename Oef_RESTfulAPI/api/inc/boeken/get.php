...
$sql="select BK_ID, BK_AU_ID, BK_GN_ID, titel, code, omschrijving, naam, voornaam, familienaam FROM Boeken JOIN Genre ON BK_GN_ID = GN_ID JOIN Auteurs ON BK_AU_ID = AU_ID";
